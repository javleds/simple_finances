...
class Container_6d7c54c122 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_6d7c54c122 $container)
			{
	...
	public function createServiceContainer(): Container_6d7c54c122
	{
		return $this;
	}
